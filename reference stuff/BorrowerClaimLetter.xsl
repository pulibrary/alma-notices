...
<!-- Need to understand better the relative paths here. Stylesheet will only pick up data if XPath starts at root. -->
        ...
        <html>
            ...
            <body>
                ...
                <table role='presentation'  cellspacing="0" cellpadding="5" border="0">
                    <tr>
                        <td>
<!-- Replacing header toggle variable. -->
                            <!--<h3>@@header@@</h3>-->
                           <h3>
                ...
                <div class="messageArea">
                    <div class="messageBody">
                        <table role='presentation'  cellspacing="0" cellpadding="5" border="0">
                             <tr>
                                 <td>
<!-- NB This data is not in DefaultLetter.xml -->
